package com.andrew.paginglibtest.presentation.feature.moviesFromRoom.adapter
...
class MoviesFromRoomAdapter(diff: DiffUtil.ItemCallback<Movie>)
    : PagedListAdapter<Movie, MoviesFromRoomAdapter.MovieViewHolder>(diff) {
